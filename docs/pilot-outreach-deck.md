...
**Tagline:** *"Your project content trains the AI that trains you."*
...
2. **"They asked about my code, not theory"** — Faculty examines the *project*, not textbooks
...
- Questions about *their* architecture, *their* implementation choices
...
|-----------|--------|------------------|
| **Technical Depth** | 30% | Can student explain *why*, not just *what* |
...
> *VivAI is built and running. All features described here are live in production.*

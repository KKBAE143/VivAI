...
function Login() {
  ...
  return (
    <div className="grid min-h-screen bg-background lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-[oklch(0.338_0.065_208)] via-[oklch(0.24_0.04_215)] to-[oklch(0.13_0.008_240)] p-12 text-[oklch(0.975_0.006_80)] lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-[oklch(0.975_0.006_80)]">
            Navigate your academics with confidence.
          </h1>
          <p className="mt-3 text-base text-[oklch(0.975_0.006_80)]/85">
            Manage projects, prep for vivas with AI, and collaborate with your team — all in one
            place.
          </p>
        </div>
        <div className="text-sm text-[oklch(0.975_0.006_80)]/75">
